...
const TodoItem = ({ todo }) => {
  ...
  const handleCheckChange = (id) => {
    ...
    //   // item.complete
    // }));
    dispatch(TodoReducerActions.checkChangeTodo({ id: id }));
  };
  ...
  const handleEditChange = () => {
    ...
    if (edited === true) {
      ...
      // }));
      dispatch(
        TodoReducerActions.textChangeTodo({ id: todo.id, text: newText })
      );
    }
  };
  ...
  const handDelete = (id) => {
    ...
    dispatch(TodoReducerActions.deleteChangeTodo({ id: id }));
  };
  return (
    <div>
